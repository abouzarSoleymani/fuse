...
export class TextFieldAutofillMonitorExample implements OnDestroy, OnInit {
  @ViewChild('first', {read: ElementRef, static: true}) firstName: ElementRef<HTMLElement>;
  @ViewChild('last', {read: ElementRef, static: true}) lastName: ElementRef<HTMLElement>;
